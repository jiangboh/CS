...
namespace ScannerBackgrdServer
{
    public class FtpHelper
    {
        ...
        /// </summary>
        /// <param name="strFileName">本地文件名</param>
        public int Put(string strFileName,byte[] data)
        {
            if (!bConnected)
            {
                Connect();
        ...
        private void ReadReply()
        {
            ...
            //Logger.Trace(LogInfoType.INFO, "ReadLine:" + strReply, "FTP", LogCategory.I);
            //FrmMainController.add_log_info(LogInfoType.INFO, "ReadLine:" + strReply);
        ...
        public bool CheckFtpConnStatus(string ip, string ftpuser, string ftppas, out string errmsg, int port = 21, int timeout = 2000)
        {
            ...
            { 
                ...
                Logger.Trace(LogInfoType.EROR,errmsg, "FTP", LogCategory.I);
                ret = false;
            }
            finally
            {
        ...
        public int SendNoop()
        {
            ...
            {
                //throw new IOException(strReply.Substring(4));
                Logger.Trace(LogInfoType.INFO, "send noop OK.", "FTP", LogCategory.I);
            }
            else
            {
                Logger.Trace(LogInfoType.INFO, "send noop NO.", "FTP", LogCategory.I);
            }
