...
namespace Monitor
{
    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            {
                MessageBox.Show("只能运行一个Monitor监控器！", "出错", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly);
        ...
        {
            string filePath = AppDomain.CurrentDomain.BaseDirectory + @"\LogMnt\Exception.txt";
